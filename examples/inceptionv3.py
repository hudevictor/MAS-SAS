...
graph = inception_v3(batch_size=16)  # change batch_size from 4 to 8 would cause error.
opt_graph = taso.optimize(graph, alpha=1.0, budget=300000000)#hbls and pgls for 300,taso for 300000000
